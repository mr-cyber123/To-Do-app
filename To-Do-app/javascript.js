...
let dbstring = 'mongodb+srv://niyas:niyas2424@cluster0.jmurn.mongodb.net/myapp?retryWrites=true&w=majority'
let dbName ='myapp'
...
app.post('/create-item',passProcted,function(req,res){
    db.collection('items').insertOne({text:req.body.item},function(){
      res.redirect('/')
    })
 
})
app.post('/update-item',passProcted, function(req,res){
